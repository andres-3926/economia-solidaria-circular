...
$pdf->MultiCell(0, 6, utf8_decode(
    "Has interactuado exitosamente con las diferentes secciones de la página 'Aprende', dentro del aplicativo desarrollado en el marco del proyecto 'Reciclando Juntas, Produciendo Futuro'."
), 0, 'C');
$pdf->Ln(8);
$pdf->MultiCell(0, 6, utf8_decode(
