...
$sql = "SELECT nombre_completo, celular, barrio, emprendimiento, direccion,foto, rol, resena, id, habilitado FROM usuarios WHERE numero_documento = ?";
...
// --- AHI AGREGA LA CONSULTA DE NOTIFICACIONES ---
$noti_pendientes = 0;
if ($usuario['rol'] === 'administrador') {
...
<body>
<?php
$esInhabilitado = ($usuario['rol'] === 'usuario' && isset($usuario['habilitado']) && intval($usuario['habilitado']) === 0);

// Determinar color del nombre en el botón perfil
$colorNombrePerfil = ($esInhabilitado) ? '#f0ad4e' : '#43be16';
?>

<?php if ($usuario['rol'] === 'emprendedor' && isset($usuario['habilitado']) && intval($usuario['habilitado']) === 0): ?>
                    ...
                    <div class="card shadow-lg rounded-3 profile-card">
                        <div class="card-body p-4">
                            ...
                            <div class="text-center mb-4">
                                    ...
                                    <?php if ($esInhabilitado): ?>
                                        <div class="badge mb-2" style="background-color: #f0ad4e; color: white; font-size:1.1em; padding:8px 18px; border-radius:8px;">
                                            <i class="fa-solid fa-hand me-2"></i> Pendiente de habilitación
                                        </div>
                                        <div class="alert alert-warning text-center" style="margin-top:18px;font-size:1.1em;font-weight:500;">
                                            <i class="fa fa-ban"></i> Tu cuenta está inhabilitada. No puedes publicar ni ver tus trueques hasta que el administrador te habilite nuevamente.
                                        </div>
                                    <?php else: ?>
                            ...
                            <!-- Contenido de pestañas -->
                                <div class="tab-content" id="perfilTabsContent">
                                    ...
                                    <div class="tab-pane fade" id="info" role="tabpanel">
                                        ...
                                        <?php else: ?>
                                            <div class="alert alert-info">
                                                Tu cuenta aún no ha sido habilitada como emprendedora. Espera a que el administrador te habilite para editar tu perfil.s
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                    ...
                                    <div class="tab-pane fade" id="trueques" role="tabpanel">
                                        <?php if (($usuario['rol'] === 'emprendedor' && intval($usuario['habilitado']) === 1) || $usuario['rol'] === 'administrador'): ?>
                                            <div class="alert alert-info mb-3" style="background-color: #e3f2fd; color: #1565c0; border-color: none;">
                                                <i class="fa fa-info-circle me-2"></i>
                                                Espacio para publicar itercambios, productos, servicios, materiales
                                            </div>
                                            <?php if ($usuario['rol'] === 'emprendedor' && intval($usuario['habilitado']) === 1): ?>
                                            <div class="card mb-4">
